$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Eric and Carolyn's Wedding",

            // Event start date
            start: new Date('Aug 03, 2023 10:00'),
            ...
            end: new Date('Aug 03, 2023 23:59'),
...
function initMap() {
    ...
    var location2 = {lat: 40.863874, lng: -73.3226836};
    var map2 = new google.maps.Map(document.getElementById('map-canvas-reception'), {
        zoom: 15,
        center: location2,
        scrollwheel: false
    });
